...
public class SubArraysSumToTarget {

    public static void main(String[] args) {
        int[] INPUT = {10,20,30,50,40};
        System.out.println(combinationSum2(INPUT,60));
//        printSubarrays(INPUT, 60);
//        System.out.println(" count : "+ countSubArrays(INPUT,60));
    }
